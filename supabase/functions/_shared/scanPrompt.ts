...
- Ignore : titres de page seuls, numéros seuls, consignes ("Let op", "Attention", "Exercice", "Page 12"), logos, tampons, marges vides, titres de section de vocabulaire (ex. "Maatschappij & conflict (société et conflit)") — ce ne sont PAS des cartes.
...
- Ne colle JAMAIS deux langues dans le même champ (interdit : "emotioneel émotionnel" ou "opsluiten enfermer" dans term OU definition). Une face = une langue / une forme.
...
- Titres de section (Birth / La naissance / 19. Les contraires / Gevoelens & reacties) : ignore-les comme cartes, mais continue d'extraire TOUS les mots en dessous.
...
TABLEAUX DE CONJUGAISON / PARADIGMES (3+ colonnes : infinitif | formes | traduction) :
- UNE ligne du tableau = UNE carte (pas 4 cartes partielles, pas un échantillon de 4 verbes).
- term = 1re colonne (ex. infinitif "kunnen").
- faces = colonnes intermédiaires dans l'ordre (ex. ["kon", "konden", "gekund"]). Tableau vide de formes → faces: [].
- definition = dernière colonne utile = traduction / gloss (ex. "pouvoir").
- INTERDIT d'écraser plusieurs colonnes dans term ("Zeggen Zei Zeiden") ou definition ("Gezegd Dire").
- Extrais TOUTES les lignes de TOUS les tableaux visibles, jusqu'à la limite maxPairs.
- Surligneurs jaunes, doigts, plis : lis quand même la ligne.
...
- Corrige les erreurs de lecture évidentes seulement si le sens est clair (accents, "pa" → "pas" en français, "émotionnel!" → "émotionnel"). Ne "corrige" pas une formule en une autre formule célèbre.
...
faces = [] pour une carte 2 faces classique. faces = formes intermédiaires pour conjugaisons / paradigmes.
...
- Pour definitions : une notion = une réponse courte. EXTRAIS TOUTES les notions/définitions visibles, jusqu'à ${maxPairs}.
- Pour notes : si c'est vraiment des notes, découpe en unités mémorables. Si c'est une liste de traduction 2 colonnes, corrige sheetType en "vocab" et aligne correctement.
- Pour math, ou dès que tu vois des formules / symboles scientifiques : transcris-les en LaTeX à partir de L'IMAGE.
- Exclus titres de section et consignes. faces: [] si carte classique 2 faces.
